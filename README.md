...
<font color="Darkred">
-Add <a href="#Google">Google's Pixel Visual Core</a>.   
-Add <a href="#Nervana">Intel Nervana™ Neural Network Processors (NNP)</a>. 
-Add <a href="#Loihi">Intel's Loihi test chip</a>.    
-Add <a href="#Nvidia">Nvidia open source Deep Learning Accelerator</a>.
-Add <a href="#Imagination">Imagination reveals PowerVR Neural Network Accelerator (NNA)</a>.  
-Add <a href="#AMD">Tesla said to be working on its own self-driving AI chip with AMD</a>.
-Add <a href="#Apple">Apple unveils A11 bionic neural engine AI chip</a>. 
-Add <a href="#HiSilicon">HiSilicon Kirin970 presentations</a>.
-Add <a href="#Movidius">Movidius Myriad™ X</a> and <a href="#Chipintelli">Chipintelli</a> in "Startup in China" section.
-Add <a href="#NovuMind">NovuMind</a> in "Startup Worldwide" section.
